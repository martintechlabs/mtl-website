...
import { ArrowLeft, ArrowRight, CheckCircle2, Target, Users } from "lucide-react";
import Image from "next/image";

export default function TeamTurnaroundPage() {
  return (
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed">
                How we transformed a struggling engineering team with high
                turnover into a stable, high-velocity unit.
              </p>
            </div>
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  The founders were frustrated by a lack of visibility into what
                  engineering was doing. Deadlines were constantly missed, and
                  developer turnover was high. They didn't know if they had the
                  right people in the right seats, or if their expectations were
                  unrealistic.
                </p>
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Culture isn't just about perks; it's about clarity and impact.
                  I established clear engineering metrics (DORA) to make
                  performance visible and objective. I mentored the lead
                  engineer to step up into a management role and restructured
                  the hiring process to test for "product-mindedness," not just
                  coding skills.
                </p>
                    ...
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Started tracking Deployment Frequency and Lead Time to
                          Change to baseline performance.
                        </p>
                      </div>
                    </div>
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Created a standardized interview rubric to reduce bias
                          and identify culture-add candidates.
                        </p>
                      </div>
                    </div>
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Defined clear growth paths for engineers so they knew
                          how to advance without leaving.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  The transformation was palpable. Deployment frequency tripled
                  as the team gained confidence. Most importantly, we retained
                  100% of key talent over the next year, and the founders
                  finally felt they had a partner in engineering rather than a
                  black box.
                </p>
              ...
              <Card className="bg-primary text-primary-foreground border-none">
                <CardContent className="p-6 space-y-4">
                  ...
                  <p className="text-primary-foreground/80 text-sm">
                    Engineering is a team sport. Let's build a championship
                    team.
                  </p>
                  <Button
                    size="lg"
