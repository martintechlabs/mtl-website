...
import { Activity, ArrowLeft, ArrowRight, CheckCircle2, Server } from "lucide-react";
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed">
                How we migrated a crashing monolithic app to a scalable
                microservices architecture to handle viral growth.
              </p>
            </div>
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  A consumer app experienced viral growth, jumping from 10k to
                  100k daily active users in weeks. Their monolithic MVP, hosted
                  on a single server, began crashing repeatedly under the load.
                  Database connections were maxing out, and latency was
                  skyrocketing, threatening to kill their momentum.
                </p>
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  We executed a "Strangler Fig" migration pattern. We didn't
                  rewrite everything at once. Instead, we peeled off the most
                  resource-intensive features (like notifications and feed
                  generation) into separate microservices, while keeping the
                  core monolith running for basic CRUD operations.
                </p>
                  ...
                  <div className="grid gap-4">
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Dockerized the application and orchestrated it with
                    ...
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Implemented read replicas and Redis caching to offload
                          80% of database traffic.
                        </p>
                      </div>
                    </div>
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Set up an Application Load Balancer to distribute
                          traffic evenly across instances.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  The new architecture handled the traffic spike effortlessly.
                  The app maintained 99.99% uptime during their biggest
                  marketing campaign ever. Additionally, by optimizing resource
                  usage, we actually reduced their monthly cloud bill by 40%.
                </p>
              ...
              <Card className="bg-primary text-primary-foreground border-none">
                <CardContent className="p-6 space-y-4">
                  ...
                  <p className="text-primary-foreground/80 text-sm">
                    Don't let success break your infrastructure. Let's scale it
                    right.
                  </p>
                  <Button
                    size="lg"
