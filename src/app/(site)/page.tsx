        ...
        <div className="container relative z-10">
          <div className="max-w-3xl space-y-6 lg:mx-auto lg:text-center lg:flex lg:flex-col lg:items-center">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight font-mono">
              Move Projects From{" "}
              <span className="text-muted-foreground line-through decoration-destructive decoration-4">
                Stuck
              </span>{" "}
              to <span className="text-primary">Shipped</span>
            </h1>
            <p className="text-xl text-muted-foreground max-w-2xl leading-relaxed lg:mx-auto">
              Helping Founders Ship Their First Product Fast with AI-Accelerated
              Engineering Teams. I fix broken processes, speed up delivery, and
              prepare platforms to scale.
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Early-stage founders often struggle because they're not sure how
                to build their product the right way. Execution slows,
                priorities get fuzzy, and it's unclear who to hire to fix it.
              </p>
              <div className="space-y-4">
                <div className="flex gap-4 items-start p-4 border rounded-lg bg-background/50">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Without a senior technical leader, it's easy to overbuild
                      or choose the wrong stack.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4 items-start p-4 border rounded-lg bg-background/50">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Bringing on engineers who can't deliver or don't fit the
                      startup pace.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4 items-start p-4 border rounded-lg bg-background/50">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Delays and messy codebases that become impossible to
                      maintain.
                    </p>
                  </div>
                </div>
              ...
              <Card className="relative border-primary/20 bg-background/80 backdrop-blur">
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="flex gap-3 items-center">
                    <CheckCircle2 className="h-5 w-5 text-primary" />
                    <span>
                      Scalable Architecture reviews and making systems reliable
                    </span>
                  </div>
                  <Separator />
                  <div className="flex gap-3 items-center">
      ...
      <section id="case-studies" className="py-20 border-b">
        <div className="container">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-4">
            <div>
              ...
              <p className="text-muted-foreground mt-2">
                Real-world examples of problems solved and value delivered.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <Link href="/case-studies/rescue-ship" className="block h-full">
              <Card className="group h-full overflow-hidden border-muted hover:border-primary/50 transition-colors flex flex-col cursor-pointer">
                ...
                <CardHeader>
                  <CardTitle className="font-mono text-xl leading-tight">
                    Unblocking a Stalled Roadmap: From 0 to Launch in 90 Days
                  </CardTitle>
                </CardHeader>
                <CardContent className="space-y-4 flex-1">
                  <div>
                    ...
                    <p className="text-sm">
                      A Series A fintech startup had a bloated backlog and a
                      team paralyzed by technical debt. No new features had
                      shipped in 4 months.
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-sm">
                      Conducted an architecture audit, implemented a pragmatic
                      Agile workflow, and cut scope to the essentials.
                    </p>
                  </div>
                  <div className="pt-2">
              ...
              <Card className="group h-full overflow-hidden border-muted hover:border-primary/50 transition-colors flex flex-col cursor-pointer">
                ...
                <CardContent className="space-y-4 flex-1">
                  <div>
                    ...
                    <p className="text-sm">
                      A healthcare data company wanted to leverage LLMs but
                      couldn't risk data privacy leaks or hallucinations.
                    </p>
                  </div>
                  <div>
                    <h4 className="text-sm font-bold text-muted-foreground uppercase tracking-wider mb-1">
                    ...
                    <p className="text-sm">
                      Designed a secure, local-first RAG (Retrieval-Augmented
                      Generation) architecture and led the engineering team to
                      build it.
                    </p>
                  </div>
                  <div className="pt-2">
            ...
            <Link href="/case-studies/scale-up" className="block h-full">
              <Card className="group h-full overflow-hidden border-muted hover:border-primary/50 transition-colors flex flex-col cursor-pointer">
                <div className="h-48 overflow-hidden bg-muted relative shrink-0">
                  <Image
                ...
                <CardContent className="space-y-4 flex-1">
                  <div>
                    ...
                    <p className="text-sm">
                      A consumer app hit viral growth, but their monolithic MVP
                      crashed every time traffic spiked.
                    </p>
                  </div>
                  <div>
                    <h4 className="text-sm font-bold text-muted-foreground uppercase tracking-wider mb-1">
                    ...
                    <p className="text-sm">
                      Migrated critical services to a microservices
                      architecture, implemented auto-scaling, and optimized
                      database queries.
                    </p>
                  </div>
                  <div className="pt-2">
            ...
            <Link href="/case-studies/team-turnaround" className="block h-full">
              <Card className="group h-full overflow-hidden border-muted hover:border-primary/50 transition-colors flex flex-col cursor-pointer">
                <div className="h-48 overflow-hidden bg-muted relative shrink-0">
                  <Image
                ...
                <CardContent className="space-y-4 flex-1">
                  <div>
                    ...
                    <p className="text-sm">
                      Founders were frustrated by a lack of visibility and high
                      developer turnover. They didn't know if they had the
                      right people.
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-sm">
                      Established clear engineering metrics (DORA), mentored the
                      lead engineer, and restructured the hiring process.
                    </p>
                  </div>
                  <div className="pt-2">
                    <div className="flex items-center gap-2 text-primary font-medium">
        ...
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-muted-foreground">
              Deep experience across the entire engineering lifecycle, from code
              to culture.
            </p>
          </div>
        ...
        <div className="container">
          <div className="bg-card border rounded-2xl p-8 md:p-12 flex flex-col md:flex-row gap-12 items-center">
            <div className="flex-1 space-y-6">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Fractional CTO with experience at Big Tech companies and
                startups. I've built products, scaled teams, and delivered
                results. My mission is to help founders navigate the complex
                technical landscape and ship products that matter.
              </p>
            ...
            <div className="flex-1 w-full flex justify-center">
              <div className="relative w-64 h-64 md:w-80 md:h-80">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-48 h-48 bg-muted rounded-full overflow-hidden border-4 border-background shadow-xl relative">
                    <Image
