...
import { ArrowRight, CheckCircle2, Code2, MessageSquare, Users } from "lucide-react";
        ...
        <div className="container relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              Flexible engagement models designed to meet you where you
              are—whether you need strategic guidance, leadership, or hands-on
              execution.
            </p>
          </div>
