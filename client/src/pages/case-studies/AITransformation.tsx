...
import { ArrowLeft, CheckCircle2, Shield, Database, ArrowRight } from "lucide-react";
                ...
                <div className="space-y-4">
                  ...
                  <ul className="grid sm:grid-cols-2 gap-4 pt-4">
                    ...
                    <li className="flex gap-3 items-start p-4 bg-muted/30 rounded-lg border">
                      ...
                      <span className="text-sm">Zero Tolerance for Hallucinations</span>
                    </li>
                  </ul>
                </div>
                  ...
                  <div className="bg-card border rounded-xl p-6 space-y-4">
                    ...
                    <div className="grid gap-4">
                      <div className="flex gap-3">
                        ...
                        <div>
                          <h4 className="font-bold text-sm">Secure Vector Database</h4>
                          <p className="text-sm text-muted-foreground">Implemented Pinecone with strict access controls to index millions of medical records.</p>
                        </div>
                      </div>
                      <div className="flex gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">Built a Python-based pipeline using LangChain to orchestrate retrieval and generation.</p>
                        </div>
                      </div>
                      <div className="flex gap-3">
                        ...
                        <div>
                          <h4 className="font-bold text-sm">Evaluation Framework</h4>
                          <p className="text-sm text-muted-foreground">Created an automated testing suite (Ragas) to measure answer accuracy and faithfulness.</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid sm:grid-cols-3 gap-4 pt-4">
                    <Card className="bg-primary/5 border-primary/20">
                      <CardContent className="p-6 flex flex-col items-center text-center gap-2">
                        <span className="text-4xl font-bold font-mono text-primary">$5M</span>
                        <span className="text-sm font-medium text-muted-foreground">New Revenue</span>
                      </CardContent>
                    </Card>
                    <Card className="bg-primary/5 border-primary/20">
                      <CardContent className="p-6 flex flex-col items-center text-center gap-2">
                    ...
                    <Card className="bg-primary/5 border-primary/20">
                      <CardContent className="p-6 flex flex-col items-center text-center gap-2">
                        <span className="text-4xl font-bold font-mono text-primary">&lt;2s</span>
                        <span className="text-sm font-medium text-muted-foreground">Query Latency</span>
                      </CardContent>
                    </Card>
                  </div>
                </div>
                ...
                <Card className="bg-primary text-primary-foreground border-none">
                  <CardContent className="p-6 space-y-4">
                    ...
                    <p className="text-primary-foreground/80 text-sm">
                      Let's build a secure AI strategy that drives real business value.
                    </p>
