...
import { ArrowLeft, CheckCircle2, Clock, BarChart3, ArrowRight } from "lucide-react";
import { Separator } from "@/components/ui/separator";

export default function RescueShip() {
  return (
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <p className="text-xl text-muted-foreground leading-relaxed">
                  How we rescued a Series A fintech startup from technical debt paralysis and shipped their MVP in record time.
                </p>
              </div>
              ...
              <div className="lg:col-span-2 space-y-12">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    A promising Series A fintech startup had secured funding but was burning cash without shipping. The engineering team was paralyzed by a bloated backlog, unclear requirements, and mounting technical debt. No new features had been released in 4 months, and investor confidence was waning.
                  </p>
                  <ul className="grid sm:grid-cols-2 gap-4 pt-4">
                    <li className="flex gap-3 items-start p-4 bg-muted/30 rounded-lg border">
                      ...
                      <span className="text-sm">4 months without a release</span>
                    </li>
                    <li className="flex gap-3 items-start p-4 bg-muted/30 rounded-lg border">
                      <BarChart3 className="h-5 w-5 text-destructive shrink-0 mt-0.5" />
                      <span className="text-sm">Bloated, unprioritized backlog</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    We needed to stop the bleeding and start shipping. My approach was "Audit, Cut, and Execute." We paused all non-critical work to conduct a rapid architecture audit and redefined the MVP scope to only what was essential for launch.
                  </p>
                  <div className="bg-card border rounded-xl p-6 space-y-4">
                    ...
                    <div className="grid gap-4">
                      <div className="flex gap-3">
                        ...
                        <div>
                          <h4 className="font-bold text-sm">Architecture Audit</h4>
                          <p className="text-sm text-muted-foreground">Identified and isolated critical technical debt that was blocking deployment.</p>
                        </div>
                      </div>
                      <div className="flex gap-3">
                        ...
                        <div>
                          <h4 className="font-bold text-sm">Pragmatic Agile</h4>
                          <p className="text-sm text-muted-foreground">Implemented a lightweight Scrum process focused on daily unblocking and weekly demos.</p>
                        </div>
                      </div>
                      <div className="flex gap-3">
                        ...
                        <div>
                          <h4 className="font-bold text-sm">Scope Ruthlessness</h4>
                          <p className="text-sm text-muted-foreground">Cut 40% of the "nice-to-have" features to focus purely on the core value proposition.</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    By focusing the team and removing obstacles, we shifted the culture from "stuck" to "shipping." The MVP launched successfully within 90 days, restoring investor trust and enabling the sales team to start closing deals.
                  </p>
                  <div className="grid sm:grid-cols-3 gap-4 pt-4">
                    <Card className="bg-primary/5 border-primary/20">
                      <CardContent className="p-6 flex flex-col items-center text-center gap-2">
                        <span className="text-4xl font-bold font-mono text-primary">90</span>
                        <span className="text-sm font-medium text-muted-foreground">Days to Launch</span>
                      </CardContent>
                    </Card>
                    <Card className="bg-primary/5 border-primary/20">
                      <CardContent className="p-6 flex flex-col items-center text-center gap-2">
                        <span className="text-4xl font-bold font-mono text-primary">60%</span>
                        <span className="text-sm font-medium text-muted-foreground">Fewer Bugs</span>
                      </CardContent>
                    </Card>
                    <Card className="bg-primary/5 border-primary/20">
                      <CardContent className="p-6 flex flex-col items-center text-center gap-2">
                        <span className="text-4xl font-bold font-mono text-primary">100%</span>
                        <span className="text-sm font-medium text-muted-foreground">Team Retained</span>
                      </CardContent>
                    </Card>
                  </div>
                </div>
              ...
              <div className="space-y-8">
                ...
                <Card className="bg-primary text-primary-foreground border-none">
                  <CardContent className="p-6 space-y-4">
                    <h3 className="font-bold font-mono text-lg">Need similar results?</h3>
                    <p className="text-primary-foreground/80 text-sm">
                      If your roadmap is stalled or your team is struggling to ship, let's talk.
                    </p>
